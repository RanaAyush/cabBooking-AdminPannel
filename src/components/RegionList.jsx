...
const RegionList = () => {
    // Sample data
    const regions = [
        { id: 11, name: 'Dehradun', distanceUnit: 'km', timezone: 'GMT+5:30', createdDate: '2024-11-15', status: 'Active' },
        { id: 22, name: 'Dehradun', distanceUnit: 'km', timezone: 'GMT+5:30', createdDate: '2024-11-15', status: 'pending' },
        { id: 33, name: 'Dehradun', distanceUnit: 'km', timezone: 'GMT+5:30', createdDate: '2024-11-15', status: 'Active' },
        { id: 44, name: 'Dehradun', distanceUnit: 'km', timezone: 'GMT+5:30', createdDate: '2024-11-15', status: 'Active' },
        { id: 54, name: 'Dehradun', distanceUnit: 'km', timezone: 'GMT+5:30', createdDate: '2024-11-15', status: 'Active' },
        { id: 65, name: 'Dehradun', distanceUnit: 'km', timezone: 'GMT+5:30', createdDate: '2024-11-15', status: 'Active' },

    ];

    const [users, setUsers] = useState(regions);
                    ...
                    <tbody>
                        {displayedUsers.map((region, index) => (
                            <tr key={region.id} className="hover:bg-gray-50">
                                ...
                                <td className="p-2 border-b-2 border-blue-200 text-center">{region.name}</td>
                                <td className="p-2 border-b-2 border-blue-200 text-center">{region.distanceUnit}</td>
                                <td className="p-2 border-b-2 border-blue-200 text-center">{region.timezone}</td>
                                <td className="p-2 border-b-2 border-blue-200 text-center">{region.createdDate}</td>
                                <td className="p-2 border-b-2 border-blue-200 text-center">
                                    <span className="text-center text-blue-500 px-2 py-1">{region.status}</span>
                                </td>
                                <td className="p-2 border-b-2 border-blue-200 text-center">
